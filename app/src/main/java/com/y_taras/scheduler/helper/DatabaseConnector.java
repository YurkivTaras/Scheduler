    ...
    private class DatabaseOpenHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion,
           ...
           /* if (oldVersion == 1 && newVersion == 2) {
                SharedPreferences appSettings = mContext.getSharedPreferences(Constants.APP_SETTINGS, Context.MODE_PRIVATE);
                int maxRuntime = appSettings.getInt(Constants.MAX_RUNTIME_FOR_TASK, 60);
